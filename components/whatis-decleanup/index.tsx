    ...
    <div>
      ...
      <div className="space-y-4">
        {problems.map((problem, index) => (
          <div key={index} className="bg-[#2f800a] p-4 min-h-[120px] md:min-h-[200px] lg:min-h-[280px] xl:min-h-[320px] flex items-center">
            <h3 className="text-lg md:text-xl lg:text-3xl font-bold text-black leading-relaxed" style={{ fontFamily: "Bebas Neue, sans-serif" }}>
              {problem.title}
            </h3>
          </div>
        ))}
...
function SolutionSection({ hideHeader = false }: SolutionSectionProps) {
  ...
  return (
    <div>
      {!hideHeader && (
        <div className="mb-6">
          <h2 className="text-3xl md:text-4xl font-black text-[#fbff00]">THE SOLUTION</h2>
        </div>
      )}

      <div className="space-y-4">
        {solutions.map((solution, index) => (
          <div key={index} className="bg-black p-4 backdrop-blur-sm border border-white/10 min-h-[120px] md:min-h-[200px] lg:min-h-[280px] xl:min-h-[320px]">
            <h3 className="text-[#FAFF00] text-lg md:text-2xl lg:text-4xl font-bold uppercase mb-2 lg:mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>
              {solution.title}
            </h3>
            <p className="text-[#58B12F] text-sm md:text-lg lg:text-2xl font-bold leading-relaxed">{solution.description}</p>
          </div>
        ))}
      </div>
    </div>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        ...
        <div className="text-center flex flex-col md:flex-row lg:text-left mb-8 lg:mb-12">
          ...
          <div className="relative md:w-[50%] min-h-[300px] md:min-h-[400px] flex items-center justify-center">
            ...
            ></div>
            <div className="absolute top-0 w-[70%] left-0 text-2xl sm:text-2xl lg:text-5xl xl:text-3xl font-black text-black uppercase leading-relaxed drop-shadow-lg">
              <div className="bg-[#FAFF00]">What is DeCleanup</div>
              <div className="bg-[#FAFF00] w-45 mt">Network?</div>
            </div>
          </div>

          {/* Right: Description */}
          <div className="md:w-[50%] pl-0 md:pl-4 lg:pl-8 mt-4 md:mt-0 flex flex-col justify-center min-h-[300px] md:min-h-[400px]">
            <div className="space-y-4 md:space-y-6">
              <div className="font-black">
                <div className="text-[#000000] text-base md:text-lg lg:text-xl xl:text-2xl leading-tight font-black">
                 <span className="bg-[#FAFF00] px-1">DECLEANUP</span> NETWORK IS A GLOBAL SYSTEM FOR COORDINATING ENVIRONMENTAL CLEANUPS AND TURNING THEM INTO
        ...
        <div className="hidden md:block mb-8 text-center">
          <div className="flex justify-center items-center space-x-4">
            ...
            <h2 className="text-4xl lg:text-6xl xl:text-7xl font-bold text-yellow-400 whitespace-nowrap">
              THE SOLUTION
            </h2>
          </div>
        </div>
