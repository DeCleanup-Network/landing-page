...
const Hero = () => {
  return (
    <div className="flex flex-col h-screen items-center  md:m-h-screen">
      ...
      <div className="sm:px-5 px-2 w-full">
        <div className="w-full mb-6 flex flex-col items-center sm:gap-y-2 gap-y-1">
          ...
          <p className="text-center w-fit text-2xl max-w-[98ch] mt-5 font-normal font-family-bebas md:text-5xl md:leading-14">
