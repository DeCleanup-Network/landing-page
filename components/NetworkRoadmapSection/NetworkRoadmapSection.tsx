...
const NetworkRoadmapSection = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Roadmap Section */}
      <div className="py-4 px-2 sm:px-4 lg:px-4">
        <div className="relative w-full bg-[#111111] py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
          {/* Header */}
          <div className="text-left mb-8 sm:mb-12 lg:mb-20 lg:bottom-10">
            <h2 className="text-3xl sm:text-4xl sm:ml-4 md:text-5xl lg:text-6xl xl:text-7xl font-black uppercase text-[#4FA02A] mb-0 leading-tight">
              NETWORK ROADMAP
            </h2>
          </div>
      ...
      <div 
        className="relative w-full bg-[#FAFF00] px-4 sm:px-6 lg:px-9" 
        style={{ 
          minHeight: '1200px',
          position: 'relative'
        }}
      >
        {/* Gallery */}
        <div className="pt-5 mb-8 sm:mb-12">
          <div className="grid grid-cols-3 gap-2 h-48 sm:h-56 md:h-64 lg:h-72">
        ...
        <div className="w-full h-0.5 bg-black mb-2 lg:mb-7 lg:mt-11"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div>
              <h3 className="text-2xl sm:text-3xl lg:text-6xl xl:text-6xl font-black uppercase text-black mb-15 mt-2 leading-tight">
                COMMUNITY IMPACT
              </h3>
            </div>
            <div>
         ...
         {/* Horizontal Line Separator */}
         <div className="w-full h-0.5 bg-black mb-4 lg:mb-9"></div>
